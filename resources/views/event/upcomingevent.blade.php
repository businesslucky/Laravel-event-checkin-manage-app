                            ...
                            <tbody>
                                @foreach ($events as $event)
                                    <tr>
                                        ...
                                        <td>{{$event->listMaxCapacity}}</td>
                                        <td>{{$event->plusOnes}}</td>
                                        <td>{{$event->listOpenTime}}</td>
                                        <td>{{$event->listCloseTime}}</td>
                                        <td>{{$event->theme}}</td>
                                        <td>{{$event->locationName}}</td>
                                        <td>
                                            <div class="table-data-feature">
                                                <a class="item" data-toggle="tooltip" data-placement="top" title="Invite" href="upcomingEvents/invite/{{$event->id}}">
                                                    <i class="zmdi zmdi-mail-send"></i>
                                                </a>
                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit" onclick="onEventEdit('{{$event->notes}}','{{$event->startTimeStamp}}','{{$event->endTimeStamp}}','{{$event->listMaxCapacity}}','{{$event->plusOnes}}','{{$event->listOpenTime}}','{{$event->listCloseTime}}','{{$event->theme}}','{{$event->location}}','{{$event->id}}')">
                                                    <i class="zmdi zmdi-edit"></i>
                                                </button>
                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Delete" onclick="onEventDelete('{{$event->id}}')">
