            ...
            <div class="section__content section__content--p35">
                <div class="header3-wrap">
                    ...
                    <div class="header__navbar">
                        ...
                        <?php if(Auth::user()->role == "EventManager" || Auth::user()->role == "SystemManager"): ?>
                            <li class="has-sub">
                                    <a href="#" >
                        ...
                        <?php endif; ?>
                        <?php if(Auth::user()->role == "DoorWorker" || Auth::user()->role == "SystemManager"): ?>
                            <li>
                                <a href="/doorworker">
                        ...
                        <?php if(Auth::user()->role == "SystemManager"): ?>
                            <li class="has-sub">
                                <a href="#">
                        ...
                        <?php else: ?>
                            <div class="account-wrap">
                                <div class="account-item account-item--style2 clearfix js-item-menu">
                                    <div class="image">
                                        <img src="<?php echo e(asset('images/icon/avatar-01.jpg')); ?>" alt="" />
                                    </div>
                                    <div class="content">
